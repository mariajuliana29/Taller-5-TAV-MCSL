<template>
 ...
 <div class="container m-1 p-3" id="container2" > 
  <div class="item4" id="itemp1">
    <h1 class="text-bg-success p-5" id="clase"> <br>¿Estas preparado?
        <br>
        ¡Empecemos! <br><br>
        </h1>
    </div>
    <div class="item4" id="itemp">
    <div class="birds">
...
:root {
    --birds-dark: #4d8160;
    --birds-medium-dark: #d6d5db;
    --birds-medium-light: #d6cece;
    --birds-light: #E2E2E2;
    --birds-bright: #FF5629;
    --birds-shadow: #DDDDDD;
  }
  ...
  .birds {
    ...
    .birds__hatdove-body {
      ...
      .birds__hatdove-body:before {
        top: 40px; left: 91px;
        border-bottom: 70px solid #1d7653;
    ...
    .birds__monitor {
      ...
      .birds__monitor:before {
        ...
        background: rgb(11, 117, 82);
        border-radius: 8px;
      }
      .birds__monitor:after {
        top: 24px; left: 10px;
        height: 4px; width: 26px;
        background: rgb(17, 0, 111);
        border-radius: 8px;
      }
    .birds__code {
      top: 32px; left: 10px;
